...
1.
**System Identity Report (`system_identity.sh`)**
...
2.
**FOSS Package Inspector (`package_inspector.sh`)**
...
3.
**Disk and Permission Auditor (`directory_auditor.sh`)**
...
5.
**Open Source Manifesto Generator (`manifesto_generator.sh`)**
